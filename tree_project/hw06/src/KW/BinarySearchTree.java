...
public class BinarySearchTree<E extends Comparable<E>>
    ...
    public E delete(E target) {
        System.out.println("BU METHOD TANIMLI DEGIL");
        if(true)  throw new IllegalArgumentException("BU METHOD TANIMLI DEGIL");
        return deleteReturn;
    }

    @Override
    public boolean remove(E target) {
        System.out.println("BU METHOD TANIMLI DEGILL");
        if(true)  throw new IllegalArgumentException("BU METHOD TANIMLI DEGIL");
        return false;
    }
